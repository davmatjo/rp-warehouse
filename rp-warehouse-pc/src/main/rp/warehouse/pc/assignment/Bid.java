...
class Bid {
    ...
    /**
     * @param item      The item the robot has chosen
     * @param owner     The robot
     * @param itemOrder The resultant item order for the robot if this bid wins
     */
    Bid(Task item, int owner, ItemOrder itemOrder) {
        this.item = item;
        this.owner = owner;
